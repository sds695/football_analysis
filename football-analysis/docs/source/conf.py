...
# football_analysis documentation build
...
from football_analysis import __version__ as release

# -- Project information -----------------------------------------------------

project = "football_analysis"
author = "Kedro"
...
htmlhelp_basename = "football_analysisdoc"
...
latex_documents = [
    (
        master_doc,
        "football_analysis.tex",
        "football_analysis Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "football_analysis",
        "Project football_analysis codebase.",
        "Data-Science",
    )
]
